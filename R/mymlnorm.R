...
#' @param mu mean of population vector
#' @param sig standard deviation of population vector
#' @param ... additional arguments
#'
#' @return a plot of the maximum likelihood estimates for the population mean and standard deviation
#' @export
#'
#' @examples mymlnorm(x=c(10,10,11,12,12,13,16,15,15),mu=seq(10,15,length=1000),sig=seq(0.1,4,length=1000),lwd=2,labcex=1)
